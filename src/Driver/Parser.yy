...
variable_declaration:
        INT id_list ';'
        {
            $$ = new VariableDeclaration("int", $2);
        }
    |   BOOLEAN id_list ';'
        {
            $$ = new VariableDeclaration("boolean", $2);
        };
...
location:
        ID
        {
            $$ = new VariableLocation(*$1);
        }
    |   ID '[' expr ']'
        {
            $$ = new VariableLocation(*$1, $3);
        };
